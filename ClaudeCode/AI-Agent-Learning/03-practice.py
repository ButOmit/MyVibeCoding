...
# 工具名 → 真实函数的映射表
tool_map = {"run_python_code": run_python_code, "get_current_time": get_current_time}

# ============ 第3步：Agent 主循环 ============
messages = [
    {"role": "system", "content": "你是一个能执行Python代码的助手。遇到需要计算的问题时，调用 run_python_code 或者 get_current_time 工具。最后用中文回答用户。"},
]

print("=" * 50)
print("AI Agent 聊天室 —— 我能帮你算数学、处理数据、获取当前时间！")
